...
inline fun <reified T> ItemComponentRenderProperties.renderProperty(name: String, noinline op: RenderPropertyConfigurationScope<T>.() -> Unit): RenderProperty<*, Item, T> =
