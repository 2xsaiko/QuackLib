...
class BlockLinkScopeImpl(val rl: ResourceLocation) : BlockLinkScope {
  ...
  @Suppress("UNCHECKED_CAST")
  override fun <T, C : BlockComponentRenderProperties, E : RenderProperty<C, T>> E.provides(renderParam: SimpleModel.RenderParam<T>) {
    this as RenderPropertyImpl<C, T>

    renderParam.setImpl(this@BlockLinkScopeImpl.rl, this)
  }
}